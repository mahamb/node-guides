...
echo -e "\e[33mYour wallet address:\e[39m $SUBSPACE_WALLET"
echo "=============================================================================================="
echo ""
...
echo -e "\e[33mYour node name:\e[39m $SUBSPACE_NODENAME"
echo "=============================================================================================="
echo ""
...
echo -e "\e[33mYour path for storing farm files\e[39m: $SUBSPACE_FARM_PATH"
echo "=============================================================================================="
echo ""
...
echo -e "\e[33mYour path for storing node files:\e[39m $SUBSPACE_NODE_PATH"
echo "=============================================================================================="
echo ""
...
echo -e "\e[33mYour plot size is:\e[39m $PLOT_SIZE"
echo "=============================================================================================="
...
if [[ `service subspaced status | grep active` =~ "running" ]]; then
  ...
  echo -e "Your Subspace node \e[41mwas not installed correctly\e[39m, please reinstall."
fi
echo "==================================================="
echo -e '\n\e[33mChecking farmer status\e[0m\n' && sleep 1
if [[ `service subspaced-farmer status | grep active` =~ "running" ]]; then
  ...
  echo -e "Your Subspace farmer \e[41mwas not installed correctly\e[39m, please reinstall."
fi
